...
// class ChromiumHandler implements IWebRenderer {
//   static const _protocol = 'http';
//   static const String _domain = 'localhost';
//   static const int _port = 56789;

//   static final BrowserType _browserType = BrowserType.fromString(
//     ServiceLocator.configuration.browser,
//   );
...
//     Future.delayed(Duration.zero, () => Process.run(_chromePath, _chromeArgs));
...
//           // );
//           // Block dialogs
//           currentPage.onDialog.listen((event) async {
//             event.dismiss();
//           });
//         }

//         // Go to a page and wait to be fully loaded
//         final response = await currentPage.goto(
//           url,
