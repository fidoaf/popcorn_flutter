      ...
      body: poster == null
          ...
          : Container(
              foregroundDecoration: BoxDecoration(
                image: DecorationImage(image: NetworkImage(poster.url), fit: BoxFit.fitHeight, opacity: 0.2),
              ),
      ...
      children: [
        ...
        if (genres.isNotEmpty)
          Column(
            ...
            children: [const Text('Genres:'), ...genres.map((g) => Text('- $g')), const SizedBox(height: 32)],
          ),
        //
        if (casting.isNotEmpty)
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [const Text('Casting:'), ...casting.map((c) => Text('- $c')), const SizedBox(height: 32)],
          ),
      ],
    );
  }
